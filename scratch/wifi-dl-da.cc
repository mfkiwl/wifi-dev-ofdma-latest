...
WifiDlOfdma::Setup (void)
{
  ...
  uint32_t schedules[][3] = { { 1, 0, 5 },    { 2, 0, 10 },   { 4, 2, 15 },
                              ...
                              { 6, 5, 64 },   { 18, 6, 93 },
                              { 6, 2, 23 },   { 3, 0, 12 },   { 4, 1, 25 },
                              { 18, 16, 5 },  { 20, 5, 4},    { 18, 12, 3 },
                              { 12, 3, 8 },   { 6, 0, 18 },   { 20, 2, 51 },
                              { 3, 2, 3 },    { 6, 0, 12 },   { 12, 1, 2 },
                              { 20, 16, 53 }, { 16, 15, 40 }, { 18, 17, 70 },
                              { 12, 11, 80 }, { 6, 5, 18 },   { 20, 19, 51 },
                              { 6, 1, 66 },   { 3, 2, 88 } };                             
